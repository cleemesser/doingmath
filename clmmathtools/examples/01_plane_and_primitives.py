...
# %% [markdown]
# # clmmathtools examples 1 — the Plane and its primitives
#
# `clmmathtools` gives you one `Plane` you draw on with chainable calls; a **backend** (matplotlib or
...
print("clmmathtools", mv.__version__)
