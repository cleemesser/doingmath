"""Interactive mathviz from a plain Python script.

Run it with a display attached:

    uv run python mathviz/examples/interactive_script.py            # analytic landscape
    uv run python mathviz/examples/interactive_script.py field      # 3D vector field
    uv run python mathviz/examples/interactive_script.py ppiped     # parallelepiped
...
def main(argv):
    ...
    print(
        f"mathviz — opening an interactive window for '{name}'. Drag to orbit; close it to exit."
    )
