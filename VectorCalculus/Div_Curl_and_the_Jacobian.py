...
#
# Every claim here is checked in code: numerically with `np.allclose`, and — where the claim is an
...
# transpose, trace, eigenvalues, the dot product) and multivariable calculus. Section 10 is a closing
# note for readers who want the group-theoretic statement; nothing before it depends on that
# language.
#
# **Contents**
#
